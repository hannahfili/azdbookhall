...
<body>
    ...
    <section class="wall">
        <section>
            <span id="big-text">Sala Ciemna</span>
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class=" col-lg-6">
                    <div class="container">
                        <span id="info-text">Sala o powierzchni 80 m², multimedialna, wyposażona w system nagłośnieniowy, podwieszany rzutnik, flipchart, klimatyzowana, z dostępem do Wi-Fi. Idealna pod szkolenia dla 20-50 osób. Możliwość ułożenia wszelkich konfiguracji krzeseł. Sala bardzo dobrze zaciemniona z uwagi na brak okien.</span>
                    </div>
                    ...
                    <form method="post">
                        ...
                        if(isset($_SESSION['zalogowany']) && ($_SESSION['zalogowany'] == true)){
                            ...
                            try {
                                ...
                                rezerwacje WHERE id_sali=4 AND DATE(poczatekRezerwacji)=DATE('" . $_POST['data'] . "') AND czyPotwierdzona=1");
                                $stmt->execute();
                            ...
                            echo '<input type="hidden" name="wybranaSala" value="Ciemna">';
