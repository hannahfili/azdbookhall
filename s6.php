...
<body>
    ...
    <section class="wall">
        <section>
            <span id="big-text">Sala Szkoleniowa</span>
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form method="post">
                        ...
                        if(isset($_SESSION['zalogowany']) && ($_SESSION['zalogowany'] == true)){
                            ...
                            try {
                                ...
                                rezerwacje WHERE id_sali=6 AND DATE(poczatekRezerwacji)=DATE('" . $_POST['data'] . "') AND czyPotwierdzona=1");
                                $stmt->execute();
                            ...
                            echo '<input type="hidden" name="wybranaSala" value="Szkoleniowa">';
