...
<body>
    ...
    <section class="wall">
        <section>
            <span id="big-text">Sala Basenowa</span>
            <div class="row">
                <div class="col-lg-7">
                ...
                <div class=" col-lg-5">
                    <div class="container">
                        <span id="info-text">Sala o powierzchni 64 m² z widokiem na strefę basenów sportowych oraz trybuny przy basenach. Sala w pełni klimatyzowana, z dostępem do Wi-Fi. Wyposażona: rzutnik, flipchart. Idealna na kameralne spotkania biznesowe, szkolenia do 30 osób, z możliwością wydzielenia strefy chillout/catering</span>
                    </div>
                    ...
                    <form method="post">
                        ...
                        if(isset($_SESSION['zalogowany']) && ($_SESSION['zalogowany'] == true)){
                            ...
                            try {
                                ...
                                rezerwacje WHERE id_sali=2 AND DATE(poczatekRezerwacji)=DATE('" . $_POST['data'] . "') AND czyPotwierdzona=1");
                                $stmt->execute();
                            ...
                            echo '<input type="hidden" name="wybranaSala" value="Basenowa">';
