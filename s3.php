...
<body>
    ...
    <section class="wall">
        <section>
            <span id="big-text">Sala Lustrzana</span>
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form method="post">
                        ...
                        if(isset($_SESSION['zalogowany']) && ($_SESSION['zalogowany'] == true)){
                            ...
                            try {
                                ...
                                rezerwacje WHERE id_sali=3 AND DATE(poczatekRezerwacji)=DATE('" . $_POST['data'] . "') AND czyPotwierdzona=1");
                                $stmt->execute();
                            ...
                            echo '<input type="hidden" name="wybranaSala" value="Lustrzana">';
