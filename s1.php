...
<body>
    ...
    <section class="wall">
        <section>
            <span id="big-text">Sala Bankietowa</span>
            <div class="row">
                <div class="col-lg-7">
                ...
                <div class=" col-lg-5">
                    <div class="container">
                        <span id="info-text">Sala o powierzchni 790 m² z bezpośrednim dostępem do szatni, kilkunastu toalet, niezależne wejście reprezentacyjne do Kompleksu. Idealna powierzchnia pod zorganizowanie imprezy firmowej dla 100-400 osób lub pokazu mody/gali biznesowej. Sala klimatyzowana, z dostępem do Wi-Fi, wyposażona: w rzutnik, system nagłaśniający, flipchart, monitorowana. Możliwość dowolnej charakteryzacji przestrzeni.</span>
                    </div>
                    ...
                    <form method="post">
                        ...
                        if(isset($_SESSION['zalogowany']) && ($_SESSION['zalogowany'] == true)){
                            ...
                            try {
                                ...
                                rezerwacje WHERE id_sali=1 AND DATE(poczatekRezerwacji)=DATE('" . $_POST['data'] . "') AND czyPotwierdzona=1");
                                $stmt->execute();
                            ...
                            echo '<input type="hidden" name="wybranaSala" value="Bankietowa">';
